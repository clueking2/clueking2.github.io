...
I plan to do another Leetcode problem. I plan to finish up the homepage of the website, including the CSS. If I have extra time, I plan to sketch out what I want the results page(s) to look like.

## Are there any temporary roadblocks?
I am struggling a little more than anticipated with some CSS elements for the homepage, but I plan to set aside extra time to read up on ways to debug and test those ideas out to help me fix the issues. Keeping on target for the website build may prove to be challenging, but I can help improve this if it becomes an issue, by simplifying parts of my website.
